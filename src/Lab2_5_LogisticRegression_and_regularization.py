...
class LogisticRegressor:
    ...
    def fit(
        ...
        for i in range(num_iterations):  # Fill the None here
            ...
            # Derivative w.r.t. the intercept
    ...
    def predict(self, X, threshold=0.5):
        ...
        clases = [1 if probability > threshold else 0 for probability in probabilities]
        classification_result = np.array(clases)
    ...
    def elasticnet_regularization(self, dw, m, C, l1_ratio):
        ...
        elasticnet_gradient = l1_ratio * (self.lasso_regularization(dw, m, C) - dw) + (
            1 - l1_ratio
        ) * (self.ridge_regularization(dw, m, C) - dw)
